...
router.get('/:id', (0, express_validator_1.check)('id', 'El id no es válido').isMongoId(), validarCampos, obtenerUsuario);
...
router.post('/login', (0, express_validator_1.check)('username', 'El nombre de usuario es requerido').notEmpty(), (0, express_validator_1.check)('contrasena', 'La contraseña de usuario es requerida').notEmpty(), validarCampos, login);
router.post('/loggout', loggout);
router.put('/:id', (0, express_validator_1.check)('id', 'El id no es válido').isMongoId(), validarCampos, actualizarUsuario);
router.delete('/:id', (0, express_validator_1.check)('id', 'El id no es válido').isMongoId(), validarCampos, borrarUsuario);
