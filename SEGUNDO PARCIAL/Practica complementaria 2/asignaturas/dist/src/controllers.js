...
const obtenerAsignaturas = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const asignaturas = yield model_1.Asignatura.find(query);
...
const obtenerAsignatura = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const asignatura = yield model_1.Asignatura.findById(id);
    res.json(asignatura);
});
...
const crearAsignatura = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existeAsignatura = yield model_1.Asignatura.findOne({ $or: [
            { codigo: body.codigo }
        ] });
    if (existeAsignatura) {
    ...
    const asignatura = new model_1.Asignatura(body);
...
const actualizarAsignatura = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const AsignaturaModificado = yield model_1.Asignatura.findByIdAndUpdate(id, body, { new: true });
...
const borrarAsignatura = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const AsignaturaEliminada = yield model_1.Asignatura.findByIdAndDelete(id);
