...
const obtenerUsuarios = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [total, Usuarios] = yield Promise.all([
        model_1.Usuario.countDocuments(),
        model_1.Usuario.find(query)
            .skip(Number(desde))
            .limit(Number(limite)),
    ]);
    res.json({
...
const obtenerUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const usuario = yield model_1.Usuario.findById(id);
    res.json(usuario);
});
exports.obtenerUsuario = obtenerUsuario;
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { username, contrasena } = req.body;
    const user = yield model_1.Usuario.findOne({ username: username });
    if (user) {
...
const crearUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existeUsuario = yield model_1.Usuario.findOne({ $or: [
    ...
    const usuario = new model_1.Usuario(body);
...
const actualizarUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const UsuarioModificado = yield model_1.Usuario.findByIdAndUpdate(id, body, {
        new: true
    });
...
const borrarUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const UsuarioEliminado = yield model_1.Usuario.findByIdAndUpdate(id, {
        estado: false
    }, {
        new: true
    });
